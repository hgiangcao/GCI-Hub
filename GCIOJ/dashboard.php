...
-->
            ...
            <a href="scoreboard.php" class="group bg-dark-surface p-8 rounded-2xl border border-gray-700 hover:border-brand-cyan transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-cyan-500/10 flex flex-col items-center justify-center text-center h-64">
        ...
        <a href="view_submissions.php" class="group bg-dark-surface p-8 rounded-2xl border border-gray-700 hover:border-brand-orange transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-orange-500/10 flex flex-col items-center justify-center text-center h-64">
            <div class="w-16 h-16 bg-orange-500/10 rounded-full flex items-center justify-center mb-6 group-hover:bg-orange-500/20 transition">
                <i class="fa-solid fa-code text-3xl text-brand-orange"></i>
            </div>
            <h2 class="text-xl font-bold text-white mb-2">Review Submissions</h2>
            <p class="text-sm text-dark-muted">Review & Run student code across problems.</p>
        </a>
