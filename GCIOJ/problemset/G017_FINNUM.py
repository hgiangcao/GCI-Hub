...
def correct_solution(number, x, y):
    for n in number:
...
def auto_grade():
    ...
    try:
        for i in range(1, n_test + 1):
            ...
            test_input = generate_int_arr(); x = generate_int_num(2, 5); y = generate_int_num(2, 5)
            ...
            try:
                ...
                # Run functions
                student_ans = solve(student_input_copy, x, y)
                correct_ans = correct_solution(test_input, x, y)
